...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	while (time1[T1] < 10600) {

      if( checkTimeAction( 0, 6000, time1[T1] ) ) {
			liftup1();
	}
     else if( checkTimeAction(6000, 6300, time1[T1] ) ){
       driveMove(SPINL);
    }
     else if( checkTimeAction(6300, 6500, time1[T1] ) ){
       driveMove(FORWARD);
    }
     else if( checkTimeAction(6500, 6700, time1[T1] ) ){
       liftdown1();
    }
     else if( checkTimeAction(6700, 6900, time1[T1] ) ){
       indown1();
    }
     else if( checkTimeAction(6900, 7400, time1[T1] ) ){
       liftup1();
    }
     else if( checkTimeAction(7400, 10000, time1[T1] ) ){
       liftdown2();
    }
     else if( checkTimeAction(10000, 10600, time1[T1] ) ){
       driveMove(SPINR);
    }

       else if (time1[T1] > 10600) {//yo while testing auto just change the time here to when u want it to stop
    	driveMove(STOP);
      liftstop();
  }
