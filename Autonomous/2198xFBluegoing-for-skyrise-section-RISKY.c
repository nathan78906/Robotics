...
if( checkTimeAction( 0,150 , time1[T1] ) ){
  ...
  if ( checkTimeAction( 150, 400, time1[T1] ) )
    ...
    driveMove(STOP);
		...
		else if (checkTimeAction(1100, 2000, time1[T1] ) ) { //1850
		liftup1();

 }
    else if (checkTimeAction(2000, 2940, time1[T1] ) ) { //1117
    driveMove(SPINR);
    liftstop();
    if (checkTimeAction (2500, 2570, time1[T1]) ) {
    	driveMove(FORWARD);
  }
}
    else if (checkTimeAction(3090, 3180, time1[T1] ) ){//100
    driveMove(STOP);
    clawstop();
  }
  //else if (checkTimeAction(7035, 7500, time1[T1] ) )
    else if (checkTimeAction(3180, 3270, time1[T1] ) ) // 1																																																																																																																																																																																																																																																															000
    driveMove(FORWARD);
   // liftdown1();
 // }
    else if (checkTimeAction(3270, 3700, time1[T1] ) ){ //93
   	clawopen();
    driveMove(STOP);
  }
    else if (checkTimeAction(3700, 3900, time1[T1] ) )
    	driveMove(BACKWARD);
    else if (checkTimeAction(3900, 4000, time1[T1] ) )//200
   	driveMove(RIGHT);
  // else if (checkTimeAction(5635, 6200, time1[T1] ) )//500
    //	indown1();
   else if (checkTimeAction(4000, 4250, time1[T1] ) )//200
     driveMove(SPINL);
 ...
 //  else if (checkTimeAction(6400, 7450, time1[T1] ) )//1117
  ...
  /* else if (checkTimeAction(7617, 7715, time1[T1] ) )//98
     ...
     liftup1();
   else if (checkTim9g b eAction(11350, 12467, time1[T1] ) )//1117
     driveMove(SPINL);
   */
    else if (time1[T1] > 4250){
    	driveMove(STOP);
