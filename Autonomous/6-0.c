	...
	if( checkTimeAction( 0,2250 , time1[T1] ) ){
			liftup1();
		}
	else if( checkTimeAction( 2250,2750 , time1[T1] ) ){
			driveMove(RIGHT);
		}
	else if( checkTimeAction( 2750,3400, time1[T1] ) ){
			driveMove(SPINR);
		}
		else if( checkTimeAction( 3400,4050 , time1[T1] ) ){
			driveMove(FORWARD);
		}
		else if( checkTimeAction( 4050,4300 , time1[T1] ) ){
			indown1();
		}
		/*if( checkTimeAction( 0,150 , time1[T1] ) ){
			driveMove(FORWARD);
	    clawopen();
	    liftup1();
	}
	  if ( checkTimeAction( 150, 400, time1[T1] ) )
	  	clawopen();
	  else if (checkTimeAction(400, 401, time1[T1] ) )
	  	clawstop();
			else if (checkTimeAction(401, 1100, time1[T1] ) ){ //250
			clawclose();
	    driveMove(STOP);
	  }
			else if (checkTimeAction(1100, 1700, time1[T1] ) ) { //1850
			liftup1();

	 }
	    else if (checkTimeAction(1700, 2600, time1[T1] ) ) { //1117
	    driveMove(SPINL);
	    liftstop();
	    if (checkTimeAction (2640, 2710, time1[T1]) ) {
	    	driveMove(FORWARD);
	  }
	}
	    else if (checkTimeAction(2710, 2800, time1[T1] ) ){//100
	    driveMove(STOP);
	    clawstop();
	  }
	  //else if (checkTimeAction(7035, 7500, time1[T1] ) )
	    else if (checkTimeAction(2800, 2940, time1[T1] ) ) {// 1			2890 + 430																																																																																																																																																																																																																																																												000
	    driveMove(FORWARD);
	  	liftdown1();
	   // liftdown1();
	 }
	    else if (checkTimeAction(2940, 3370, time1[T1] ) ){ //93 3320 - 2890 430
	   	clawopen();
	    driveMove(STOP);
	  }
	    else if (checkTimeAction(3370, 3570, time1[T1] ) )
	    	driveMove(BACKWARD);
	    else if (checkTimeAction(3570, 3670, time1[T1] ) )//200 100
	   	driveMove(LEFT);
	  // else if (checkTimeAction(5635, 6200, time1[T1] ) )//500
	    //	indown1();
	   else if (checkTimeAction(3670, 3920, time1[T1] ) )//200
	     driveMove(SPINR);
	   //else if (checkTimeAction(5400, 6500, time1[T1] ) )//100
	   //  driveMove(BACKWARD);

	 //  else if (checkTimeAction(6400, 7450, time1[T1] ) )//1117
	   //  driveMove(SPINR);
	  /* else if (checkTimeAction(7617, 7715, time1[T1] ) )//98
	     clawclose();
	   else if (checkTimeAction(7715, 11350, time1[T1] ) )//3.5 sec
	     liftup1();
	   else if (checkTimeAction(11350, 12467, time1[T1] ) )//1117
	     driveMove(SPINL);
	   */

	    else if (time1[T1] > 4300){
	    	driveMove(STOP);
	      liftstop();
	  }
