...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	while (time1[T1] < 15000) {
      ...
      if( checkTimeAction( 0, 4500, time1[T1] ) ) {
       ...
       liftdown1();//liftdown2 is faster than liftdown1 wtf???
    }
     ...
     else if( checkTimeAction(7600, 8600, time1[T1] ) ){
       driveMove(FORWARD);
    }
     else if( checkTimeAction(8600, 8800, time1[T1] ) ){
       inup1();
    }
     else if( checkTimeAction(8800, 11000, time1[T1] ) ){
       liftup1();
    }
     else if( checkTimeAction(11000, 11300, time1[T1] ) ){
       driveMove(SPINR);
    }
     else if( checkTimeAction(11300, 11600, time1[T1] ) ){
       driveMove(FORWARD);
    }
     else if( checkTimeAction(11600, 12000, time1[T1] ) ){
       liftdown1();
    }
     else if( checkTimeAction(12000, 12250, time1[T1] ) ){
       indown1();
    }
     else if( checkTimeAction(12250, 12500, time1[T1] ) ){
       liftup1();
    }
     else if( checkTimeAction(12500, 13000, time1[T1] ) ){
       driveMove(SPINL);
    }
     else if( checkTimeAction(13000, 15000, time1[T1] ) ){
       liftdown1();
    }

       else if (time1[T1] > 15000) {//yo while testing auto just change the time here to when u want it to stop
    	driveMove(STOP);
      liftstop();
  }
  //why do we have this at the bottom??? o well y0l0
    /*/
    else if ( checkTimeAction(7750,8750, time1[T1] ) ) {
        liftdown1();
   }

    else if ( checkTimeAction(8750,15000, time1[T1] ) ) {
    	indown1();
    }

	else if ( checkTimeAction(7950,8000, time1[T1] ) ) {
    	liftup1();
}
		else if ( checkTimeAction(8000,8200, time1[T1] ) ) {// spin to get other cube
				driveMove(SPINR);
}
   else if( checkTimeAction( 8200, 8400, time1[T1] ) ) {//move forward to cube
			driveMove (FORWARD);
	}
		else if( checkTimeAction( 8400, 8600 , time1[T1] ) ) {
			inup1();
		}
		else if( checkTimeAction( 8600, 8800, time1[T1] ) ) {
			liftup1();
		}
		else if( checkTimeAction( 8800, 9000, time1[T1] ) ) {
			driveMove(SPINR);
		}
		else if ( checkTimeAction(9000, 9300, time1[T1] ) ) {
			driveMove(FORWARD);
		}
		else if( checkTimeAction( 9300, 9500, time1[T1] ) ){
			liftdown1();
		}
		else if( checkTimeAction( 9500, 9750, time1[T1] ) ){
			indown1();
		}
		else if( checkTimeAction( 9750, 10750, time1[T1] ) ) {
			liftup1();
		}
		else if ( checkTimeAction(10750, 11500, time1[T1] ) ) {
			driveMove(SPINL);
		}
		else if( checkTimeAction( 11500, 15000, time1[T1] ) ){
			liftdown1();
		}
		/*else if ( checkTimeAction( 9500, 12500, time1[T1] ) ) {
			liftup1();//Raise lift to place cube
		}
		else if( checkTimeAction( 12500, 15000, time1[T1] ) ) {
			liftdown2();//Place cube onto the tower thing
	    indown1();
	  }
*/
