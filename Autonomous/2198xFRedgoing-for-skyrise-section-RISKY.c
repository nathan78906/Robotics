...
/////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ( checkTimeAction( 150, 400, time1[T1] ) )
    ...
    else if (checkTimeAction(1700, 2710, time1[T1] ) ) { //1117
    driveMove(SPINR);
    if (checkTimeAction (1710, 2610, time1[T1] ) ) {
    liftstop();
  }
    if (checkTimeAction (2900, 2820, time1[T1]) ) {
    	driveMove(FORWARD);
  }
}
    else if (checkTimeAction(2820, 2770, time1[T1] ) ){//100
    driveMove(STOP);
    clawstop();
  }
  //else if (checkTimeAction(7035, 7500, time1[T1] ) )
    else if (checkTimeAction(2820, 3330, time1[T1] ) ) {// 1			2890 + 430																																																																																																																																																																																																																																																												000
    driveMove(STOP);
  	liftdown1();
   // liftdown1();
  	if (checkTimeAction (3330, 3430, time1[T1] ) ) {
 }
}
    else if (checkTimeAction(3430, 3860, time1[T1] ) ){ //93 3320 - 2890 430
   	clawopen();
    driveMove(STOP);
  }
    else if (checkTimeAction(3860, 3940, time1[T1] ) )
    	driveMove(BACKWARD);
    else if (checkTimeAction(3940, 4040, time1[T1] ) )//200 100
   	driveMove(RIGHT);
  // else if (checkTimeAction(5635, 6200, time1[T1] ) )//500
    //	indown1();
   else if (checkTimeAction(4040, 4290, time1[T1] ) )//200
     driveMove(SPINL);
